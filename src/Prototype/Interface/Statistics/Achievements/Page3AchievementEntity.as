package Prototype.Interface.Statistics.Achievements 
{
	 ...
	 * @author Amidos
	 */
	public class Page3AchievementEntity extends BaseAchievementEntity
	{
		[Embed(source = "../../../../../assets/Graphics/Achievements.png")]private var achievementClass:Class;
		private var pageNumber:int = 3;
		
		public function Page3AchievementEntity(direction:int) 
		{
			...
			names.push(new Text("Master Unlocker"));
			names.push(new Text("Little Collector"));
			names.push(new Text("Collector"));
			names.push(new Text("Master Collector"));
			cond.push(new Text("Unlock all characters"));
			cond.push(new Text("Collect 10 crates"));
			cond.push(new Text("Collect 100 crates"));
			cond.push(new Text("Collect 500 crates"));
